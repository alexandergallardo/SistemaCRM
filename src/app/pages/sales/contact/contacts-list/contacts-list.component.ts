...
import { ContactsAddComponent, InformacionVentanaContactos } from '../contacts-add/contacts-add.component';
...
export class ContactsListComponent implements OnInit {
  ...
  public agregar() {
    const informacion: InformacionVentanaContactos = {
      tipo_vista: 'crear',
    }
